---
title: "Get Started with Traffic Blocker in 3 Steps"
...
When you export your rules (Settings → Export), each rule is serialised in the following format. You can also author rules by hand and import them as a JSON file:
...
- **`excludedInitiatorDomains`** — domains from which the rule should *not* fire (e.g. your local dev environment).
